...
class HeatPumpLogViewDto(BaseModel):
    ...
    heat_pump_state_defrost_req_active: Optional[StrictInt] = Field(default=None, description="Amount of seconds the heat pump spend in the defrost required active state for this interval", alias="heatPumpStateDefrostReqActive")
    heat_pump_state_defrost_open_valve: Optional[StrictInt] = Field(default=None, description="Amount of seconds the heat pump spend in the defrost opening valve state for this interval", alias="heatPumpStateDefrostOpenValve")
    heat_pump_state_defrost_close_valve: Optional[StrictInt] = Field(default=None, description="Amount of seconds the heat pump spend in the defrost state closing valve for this interval", alias="heatPumpStateDefrostCloseValve")
    heat_pump_state_defrost_drip: Optional[StrictInt] = Field(default=None, description="Amount of seconds the heat pump spend in the defrost drip state for this interval", alias="heatPumpStateDefrostDrip")
    heat_pump_state_defrost_cooling: Optional[StrictInt] = Field(default=None, description="Amount of seconds the heat pump spend in the defrost cooling state for this interval", alias="heatPumpStateDefrostCooling")
    ...
    heat_pump_state_legionnaires_disease_prevention: Optional[StrictInt] = Field(default=None, description="Amount of seconds the heat pump spend in the Legionnaires' Disease Prevention state for this interval", alias="heatPumpStateLegionnairesDiseasePrevention")
    ...
    p_requested_average: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average Power requested by the heat pump for this interval (staff only)", alias="pRequestedAverage")
    p_requested_min: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Minimum Power requested by the heat pump for this interval (staff only)", alias="pRequestedMin")
    p_requested_max: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Maximum Power requested by the heat pump for this interval (staff only)", alias="pRequestedMax")
    power_error_integral_average: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average value of the PowerErrorIntegral for this interval (staff only)", alias="powerErrorIntegralAverage")
    power_error_integral_min: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Minimum value of the PowerErrorIntegral for this interval (staff only)", alias="powerErrorIntegralMin")
    power_error_integral_max: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Maximum value of the PowerErrorIntegral for this interval (staff only)", alias="powerErrorIntegralMax")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.p_requested_average is None and "p_requested_average" in self.model_fields_set:
            _dict['pRequestedAverage'] = None

        # set to None if p_requested_min (nullable) is None
        # and model_fields_set contains the field
        if self.p_requested_min is None and "p_requested_min" in self.model_fields_set:
            _dict['pRequestedMin'] = None

        # set to None if p_requested_max (nullable) is None
        # and model_fields_set contains the field
        if self.p_requested_max is None and "p_requested_max" in self.model_fields_set:
            _dict['pRequestedMax'] = None

        # set to None if power_error_integral_average (nullable) is None
        # and model_fields_set contains the field
        if self.power_error_integral_average is None and "power_error_integral_average" in self.model_fields_set:
            _dict['powerErrorIntegralAverage'] = None

        # set to None if power_error_integral_min (nullable) is None
        # and model_fields_set contains the field
        if self.power_error_integral_min is None and "power_error_integral_min" in self.model_fields_set:
            _dict['powerErrorIntegralMin'] = None

        # set to None if power_error_integral_max (nullable) is None
        # and model_fields_set contains the field
        if self.power_error_integral_max is None and "power_error_integral_max" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "heatPumpStateDefrostReqActive": obj.get("heatPumpStateDefrostReqActive"),
            "heatPumpStateDefrostOpenValve": obj.get("heatPumpStateDefrostOpenValve"),
            "heatPumpStateDefrostCloseValve": obj.get("heatPumpStateDefrostCloseValve"),
            "heatPumpStateDefrostDrip": obj.get("heatPumpStateDefrostDrip"),
            "heatPumpStateDefrostCooling": obj.get("heatPumpStateDefrostCooling"),
            "heatPumpStateCooling": obj.get("heatPumpStateCooling"),
            "heatPumpStateDHW": obj.get("heatPumpStateDHW"),
            "heatPumpStateLegionnairesDiseasePrevention": obj.get("heatPumpStateLegionnairesDiseasePrevention"),
            ...
            "pRequestedAverage": obj.get("pRequestedAverage"),
            "pRequestedMin": obj.get("pRequestedMin"),
            "pRequestedMax": obj.get("pRequestedMax"),
            "powerErrorIntegralAverage": obj.get("powerErrorIntegralAverage"),
            "powerErrorIntegralMin": obj.get("powerErrorIntegralMin"),
            "powerErrorIntegralMax": obj.get("powerErrorIntegralMax"),

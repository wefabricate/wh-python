...
class HeatPumpApi:
    ...
    @validate_call
    def api_v1_heat_pumps_get_with_http_info(
        self,
        search: Annotated[Optional[StrictStr], Field(description="String with keywords (split by spaces) to search on SN, PN and Name of a heat pump")] = None,
        page: Annotated[Optional[StrictInt], Field(description="The page number")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The page size")] = None,
    ...
    @validate_call
    def api_v1_heat_pumps_get_without_preload_content(
        self,
        search: Annotated[Optional[StrictStr], Field(description="String with keywords (split by spaces) to search on SN, PN and Name of a heat pump")] = None,
        page: Annotated[Optional[StrictInt], Field(description="The page number")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The page size")] = None,
    ...
    @validate_call
    def api_v1_heat_pumps_heat_pump_id_get_without_preload_content(
        self,
        heat_pump_id: Annotated[StrictStr, Field(description="The heatPumpId of the heat pump you want to get")],
        x_version: Annotated[Optional[StrictStr], Field(description="Optional version parameter for frontend applications to check if an update / refresh is needed")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def api_v1_heat_pumps_sn_serial_number_get(
        self,
        serial_number: Annotated[StrictStr, Field(description="The serial number of the heat pump you want to get")],
        x_version: Annotated[Optional[StrictStr], Field(description="Optional version parameter for frontend applications to check if an update / refresh is needed")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        """Gets a heat pump by Serial Number
        ...
        _param = self._api_v1_heat_pumps_sn_serial_number_get_serialize(
    ...
    @validate_call
    def api_v1_heat_pumps_sn_serial_number_get_without_preload_content(
        self,
        serial_number: Annotated[StrictStr, Field(description="The serial number of the heat pump you want to get")],
        x_version: Annotated[Optional[StrictStr], Field(description="Optional version parameter for frontend applications to check if an update / refresh is needed")] = None,
        _request_timeout: Union[
    ...
    def _api_v1_heat_pumps_sn_serial_number_get_serialize(
        self,
        serial_number,
        x_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/heat-pumps/sn/{serialNumber}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

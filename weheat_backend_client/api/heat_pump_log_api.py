...
class HeatPumpLogApi:
    ...
    @validate_call
    def api_v1_heat_pumps_heat_pump_id_logs_get_with_http_info(
        self,
        heat_pump_id: Annotated[StrictStr, Field(description="The id of the heat pump")],
        start_time: Annotated[Optional[datetime], Field(description="Start time of the interval as a DateTime object in UTC (format: yyyy-MM-dd HH:mm:ss)")] = None,
        end_time: Annotated[Optional[datetime], Field(description="End time of the interval as a DateTime object in UTC (format: yyyy-MM-dd HH:mm:ss)")] = None,
    ...
    @validate_call
    def api_v1_heat_pumps_heat_pump_id_logs_get_without_preload_content(
        self,
        heat_pump_id: Annotated[StrictStr, Field(description="The id of the heat pump")],
        start_time: Annotated[Optional[datetime], Field(description="Start time of the interval as a DateTime object in UTC (format: yyyy-MM-dd HH:mm:ss)")] = None,
        end_time: Annotated[Optional[datetime], Field(description="End time of the interval as a DateTime object in UTC (format: yyyy-MM-dd HH:mm:ss)")] = None,
    ...
    @validate_call
    def api_v1_heat_pumps_heat_pump_id_logs_latest_get(
        self,
        heat_pump_id: Annotated[StrictStr, Field(description="The id of the heat pump")],
        x_version: Annotated[Optional[StrictStr], Field(description="Optional version parameter for frontend applications to check if an update / refresh is needed")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def api_v1_heat_pumps_heat_pump_id_logs_latest_get_with_http_info(
        self,
        heat_pump_id: Annotated[StrictStr, Field(description="The id of the heat pump")],
        x_version: Annotated[Optional[StrictStr], Field(description="Optional version parameter for frontend applications to check if an update / refresh is needed")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def api_v1_heat_pumps_heat_pump_id_logs_latest_get_without_preload_content(
        self,
        heat_pump_id: Annotated[StrictStr, Field(description="The id of the heat pump")],
        x_version: Annotated[Optional[StrictStr], Field(description="Optional version parameter for frontend applications to check if an update / refresh is needed")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def api_v1_heat_pumps_heat_pump_id_logs_raw_get_with_http_info(
        self,
        heat_pump_id: Annotated[StrictStr, Field(description="The id of the heat pump")],
        start_time: Annotated[Optional[datetime], Field(description="Start time of the interval as a DateTime object in UTC (format: yyyy-MM-dd HH:mm:ss)")] = None,
        end_time: Annotated[Optional[datetime], Field(description="End time of the interval as a DateTime object in UTC (format: yyyy-MM-dd HH:mm:ss)")] = None,
    ...
    @validate_call
    def api_v1_heat_pumps_heat_pump_id_logs_raw_get_without_preload_content(
        self,
        heat_pump_id: Annotated[StrictStr, Field(description="The id of the heat pump")],
        start_time: Annotated[Optional[datetime], Field(description="Start time of the interval as a DateTime object in UTC (format: yyyy-MM-dd HH:mm:ss)")] = None,
        end_time: Annotated[Optional[datetime], Field(description="End time of the interval as a DateTime object in UTC (format: yyyy-MM-dd HH:mm:ss)")] = None,
